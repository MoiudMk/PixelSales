    ...
    final ok = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
          ...
          child: Column(
            children: [
              ...
              TextField(
                controller: b,
                decoration:
                    const InputDecoration(labelText: 'الباركود (اختياري)'),
              ),
            ],
          ),
        ),
        actions: [
          ...
          FilledButton(
            onPressed: () async {
              final price = double.tryParse(pr.text);
              final qty = int.tryParse(q.text);

              if (n.text.trim().isEmpty || price == null || qty == null) {
                return;
              }
